...
public class URLPathSettings {
    ...
    public URLPathSettings(WebDriver webWebWebDriver) {
    ...
    public void VerifyContentNodeAlias(String title) throws Exception {
        ...
        Assert.assertEquals(webWebWebDriver.getCurrentUrl().replace(config.getConfigValueString("AppURL") + "/", ""), "content/" + title.toLowerCase());
    }
