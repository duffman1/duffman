...
public class EventCountdown {
    ...
    public EventCountdown(WebDriver webWebWebDriver) {
    ...
    private WebElement CountdownTimer_Ctr(String eventTitle) {
        return webWebWebDriver.findElement(By.xpath("//h3[text()='" + eventTitle + "']/..//div[contains(@id, 'field-event-timer')]"));
    }

    private WebElement ActiveColor_Ctr(String eventTitle, String hexColor) {
        return webWebWebDriver.findElement(By.xpath("//h3[text()='" + eventTitle + "']/..//div[@class='event-countdown-active']/div[@style='background-color:" + hexColor + ";']"));
    }

    private WebElement ActiveAction_Lnk(String eventTitle, String href) {
        return webWebWebDriver.findElement(By.xpath("//h3[text()='" + eventTitle + "']/..//div[@class='event-countdown-active']//a[@href='" + href + "']"));
    }

    private WebElement Active_Img(String eventTitle, String imageIndex) {
        return webWebWebDriver.findElement(By.xpath("(//h3[text()='" + eventTitle + "']/..//div[@class='event-countdown-active']//img)[" + imageIndex + "]"));
    }

    private WebElement ExpiryColor_Ctr(String eventTitle, String hexColor) {
        return webWebWebDriver.findElement(By.xpath("//h3[text()='" + eventTitle + "']/..//div[@class='event-countdown-expiry']/div[@style='background-color:" + hexColor + ";']"));
    }

    private WebElement ExpiryAction_Lnk(String eventTitle, String href) {
        return webWebWebDriver.findElement(By.xpath("//h3[text()='" + eventTitle + "']/..//div[@class='event-countdown-expiry']//a[@href='" + href + "']"));
    }

    private WebElement Expiry_Img(String eventTitle, String imageIndex) {
        return webWebWebDriver.findElement(By.xpath("(//h3[text()='" + eventTitle + "']/..//div[@class='event-countdown-expiry']//img)[" + imageIndex + "]"));
    }
    ...
    public void WaitForCountDownExpiration(final String eventTitle) throws Exception {
        ...
        new WebDriverWait(webWebWebDriver, 120).until(new ExpectedCondition<Boolean>() {
    ...
    public void VerifyActiveImagePresent(String eventTitle, String imageSrc, String imageIndex) throws Exception {
        ...
        for (int second = 0; ; second++) {
            ...
            imgLoaded = (Boolean) ((JavascriptExecutor) webWebWebDriver).executeScript(
