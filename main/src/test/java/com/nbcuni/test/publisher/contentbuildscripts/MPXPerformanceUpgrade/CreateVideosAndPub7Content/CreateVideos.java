...
public class CreateVideos extends ParentTest{
    ...
    public void Test() throws Exception {
    	...
    	for(int CCount=0;CCount<100;CCount++) {
    		...
    		String filePath = System.getProperty("user.dir") + "/src/test/java/com/nbcuni/test/publisher/contentbuildscripts/MPXPerformanceUpgrade/CreateVideosAndPub7Content/AssetsCreated.txt";
