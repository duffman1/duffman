...
public class CoverMedia {
    ...
    public CoverMedia(final CustomWebDriver custWebDr) {
        webDriver = custWebDr;
    ...
    @FindBy(how = How.XPATH, using = "//div[contains(@id, 'edit-field-cover-media')]//img")
    private static WebElement CoverMedia_Img;
    
    @FindBy(how = How.XPATH, using = "//div[contains(@id, 'edit-field-cover-media')]//a[text()='Edit']")
    private static WebElement Edit_Btn;
    
    @FindBy(how = How.XPATH, using = "//div[contains(@id, 'edit-field-cover-media')]//a[text()='Select']")
