...
public class GigyaShareBar {
    ...
    public GigyaShareBar(WebDriver webWebWebDriver) {
    ...
    public void ClickTweetButton() throws Exception {
        ...
        webWebWebDriver.switchTo().frame(waitFor.ElementPresent(Twitter_Frm));
    ...
    public void ClickLikeButton() throws Exception {
        ...
        webWebWebDriver.switchTo().frame(waitFor.ElementPresent(Facebook_Frm));
