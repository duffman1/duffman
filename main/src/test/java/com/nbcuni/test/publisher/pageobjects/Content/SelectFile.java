...
public class SelectFile {
    ...
    public SelectFile(WebDriver webWebWebDriver) {
    ...
    public void SwitchToSelectFileFrm() throws Exception {
        ...
        for (int I = 0; I <= timeout; I++) {
            ...
            webWebWebDriver.switchTo().frame(waitFor.ElementPresent(SelectFile_Frm));

            try {
                webWebWebDriver.findElement(MediaBrowser_Tst);
                break;
    ...
    public void ClickUploadBtn() throws Exception {
        ...
        try {
            Thread.sleep(500);
            Alert alert1 = webWebWebDriver.switchTo().alert();
            alert1.accept();
            webWebWebDriver.switchTo().defaultContent();
    ...
    public Boolean ClickPublicLocalFilesRdb() throws Exception {
        ...
        try {
            ele = webWebWebDriver.findElement(PublicLocalFiles_Rdb);
