...
public class EmbedVideo {
    ...
    public EmbedVideo(WebDriver webWebWebDriver) {
    ...
    public void SwitchToSynopsisFrm() throws Exception {
        ...
        webWebWebDriver.switchTo().frame(waitFor.OneElementOrAnotherPresent(Synopsis_Frm, WYSIWYGSynopsis_Frm));
    ...
    public void RightClickEditMPXVideoBtn(String index) throws Exception {
        ...
        Thread.sleep(1000);
        new Actions(webWebWebDriver).contextClick(waitFor.ElementVisible(EmbededMPXVideo_Tag(index)))
    ...
    public void RightClickEditYouTubeVideoBtn(String index) throws Exception {
        ...
        Thread.sleep(1000);
        new Actions(webWebWebDriver).contextClick(waitFor.ElementVisible(EmbededYouTubeVideo_Tag(index)))
    ...
    public void DoubleClickImagePropertiesBtn(String index) throws Exception {
        ...
        new Actions(webWebWebDriver).doubleClick(waitFor.ElementVisible(EmbeddedImage_Img(index))).build().perform();
