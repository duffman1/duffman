...
public class CreateDefaultContent {
    ...
    public CreateDefaultContent(WebDriver webWebWebDriver) {
        navigation = new EmberNav(webWebWebDriver);
        random = new Random();
        basicInformation = new BasicInformation(webWebWebDriver);
        contentParent = new ContentParent(webWebWebDriver);
        publishingOptions = new PublishingOptions(webWebWebDriver);
        selectFile = new SelectFile(webWebWebDriver);
        charactersInformation = new CharactersInformation(webWebWebDriver);
        coverPhoto = new CoverPhoto(webWebWebDriver);
        personsInformation = new PersonsInformation(webWebWebDriver);
        coverMedia = new CoverMedia(webWebWebDriver);
        logo = new Logo(webWebWebDriver);
        banner = new Banner(webWebWebDriver);
        relationships = new Relationships(webWebWebDriver);
    }
