...
public class AutoLogout {
    ...
    public AutoLogout(WebDriver webWebWebDriver) {
    ...
    public void VerifyAutoLogoutConfirmationPresent(Integer maxWaitTime) throws Exception {
        ...
        new WaitFor(webWebWebDriver, maxWaitTime).ElementContainsText(AutoLogoutConfirm_Txt, "Your session is about to expire. Do you want to reset it?");
