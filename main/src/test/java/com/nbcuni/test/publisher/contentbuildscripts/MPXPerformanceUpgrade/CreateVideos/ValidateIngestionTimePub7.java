...
public class ValidateIngestionTimePub7 extends ParentTest{
    ...
    public void Test() throws Exception {
	    ...
	    String assetCreationFilePath = System.getProperty("user.dir") + "/src/test/java/com/nbcuni/test/publisher/contentbuildscripts/MPXPerformanceUpgrade/CreateVideos/AssetsCreated.txt";
